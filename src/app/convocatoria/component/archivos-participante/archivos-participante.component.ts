    ...
    var dConfirm = this._dialog.open(CustomModalComponent,
      {
        width: '450px',
        data: {
          mensaje: "Recuerde: si usted no cargó la totalidad de los documentos, podrá cargarlos posteriormente en cualquier momento antes del cierre de la etapa de cargue de documentos según el cronograma de la convocatoria.",
